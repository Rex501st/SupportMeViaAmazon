// ==UserScript==
// @name        Rex501st affiliate
// @name:ja     Rex501st affiliate
// @name:zh-CN  Rex501st affiliate
// @namespace   Rex501st
// @description Supports Rex501st on GitHub every time you shop on Amazon. 
// @description:ja Supports Rex501st on GitHub every time you shop on Amazon.。
// @description:zh-CN Supports Rex501st on GitHub every time you shop on Amazon.。
...
(function(){
  ...
  */
  if(window === top){
    const IDS = {
      'www.amazon.com':   'rex501st-20',
      'www.amazon.co.jp': 'rex501st-20',
      'www.amazon.co.uk': 'rex501st-20',
      'www.amazon.es':    'rex501st-20',
      'www.amazon.fr':    'rex501st-20',
      'www.amazon.de':    'rex501st-20',
      'www.amazon.it':    'rex501st-20',
    };
